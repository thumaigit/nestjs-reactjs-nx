...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/Fdnb3LeLcB)
...
```sh
npx nx serve reactjs
```

To create a production bundle:

```sh
npx nx build reactjs
```

To see all available targets to run for a project, run:

```sh
npx nx show project reactjs
```
